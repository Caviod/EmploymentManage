            ...
            <div class="rightarea2">
               ...
               <table style="line-height: 30px; width: 100%;">
                    ...
                    <tr>
                        ...
                        <td >
                             <%#BLL.UsersBLL.GetIdByUsers(Convert.ToInt32( Eval("UserId"))).RealName%>
                        </td>
                        <td>
                          <%#BLL.UsersBLL.GetIdByUsers(Convert.ToInt32( Eval("UserId"))).Sex%>
                        </td>
                        <td>
                             <%#BLL.UsersBLL.GetIdByUsers(Convert.ToInt32( Eval("UserId"))).Education%>
                        </td>
                        <td>
                             <%#BLL.UsersBLL.GetIdByUsers(Convert.ToInt32( Eval("UserId"))).Major%>
                        </td>
                        ...
                        <td><a href="usersdetail.aspx?id=<%#Eval("UserId")%>&appId=<%#Eval("ApplyId")%>&hir=<%#Eval("HireId")%>">阅读详细</a></td>
                    </tr>
                     </ItemTemplate>
