<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hiremanage.aspx.cs" Inherits="hiremanage" %>
    ...
    <div class="bg">
        ...
        <div class="menu">
            ...
            <div class="menu-blank" id="menu6" onmousemove="chnage('menu6')" onmouseout="chnage2('menu6')">
                <a href="registeredusers.aspx">学生注册</a></div>
            ...
            <div class="rightarea2">
               ...
               <table style="line-height: 30px; width: 100%;">
                    ...
                    <tr>
                        ...
                        <td><a href="userslist.aspx?id=<%#Eval("HireId")%>">查看该职位申请</a>&nbsp;|&nbsp;<a href="hireadd.aspx?id=<%#Eval("HireId")%>">编辑</a>&nbsp;|&nbsp;<asp:LinkButton
                                    ID="lnkbDel" runat="server"  OnClientClick='return confirm("确定要删除该项？")' 
            onclick="lnkbDel_Click" CommandArgument='<%#Eval("HireId")%>'  >删除</asp:LinkButton></td>
                    </tr>
                     </ItemTemplate>
