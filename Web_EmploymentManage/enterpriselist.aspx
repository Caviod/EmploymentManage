<%@ Page Language="C#" AutoEventWireup="true" CodeFile="enterpriselist.aspx.cs" Inherits="enterpriselist" %>
                ...
                <table>
                    <tr >
                        <td style="height:100px; line-height:30px;">
                                                        关键字：<input id="txtKey" runat="server" title="企业名称" style="width: 100px;" type="text" /><br />
               ...
               <table style="line-height: 30px; width: 100%;">
                    ...
                    <tr>
                        <td style="text-align: left; padding-left: 20px; color: #1974c5; font-size: 14px;
                            font-weight: bold;">
                        <a href="enterprisedetail.aspx?id=<%#Eval("EnterpriseId")%>" target="_blank"><%#Eval("EnterpriseName")%></a>
                        </td>
                        <td >
                            <%#Eval("Industry")%>
                        </td>
