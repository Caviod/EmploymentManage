<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hirelist.aspx.cs" Inherits="hirelist" %>
    ...
    <div class="bg">
        ...
        <div class="leftbody">
            ...
            <div class="leftarea3">
                ...
                <table>
                    <tr >
                        <td style="height:100px; line-height:30px;">
                            关键字：<input id="txtKey" runat="server" title="职位名称" style="width: 100px;" type="text" /><br />
        ...
        <div class="rightbody">
                ...
                <table style="line-height: 30px; width: 100%;">
                    ...
                    <tr>
                        <td style="text-align: left; padding-left: 20px; color: #1974c5; font-size: 14px;
                            font-weight: bold;">
                          <a href="hiredetail.aspx?id=<%#Eval("HireId")%>" target="_blank"><%#Eval("Job")%></a>
                        </td>
                        <td style="text-align: left; padding-left: 20px; color: #1974c5;">
                             <a href="enterprisedetail.aspx?id=<%#Eval("EnterpriseId")%>" target="_blank"><%#BLL.EnterpriseBLL.GetIdByEnterprise(Convert.ToInt32(Eval("EnterpriseId"))).EnterpriseName%></a>
                        </td>
                        <td>
                               <%#Eval("Address")%>
                        </td>
          ...
          <asp:Label ID="lblEmpty" Text="暂无信息！"  runat="server" Visible='<%#bool.Parse((rpView.Items.Count==0).ToString())%>'>
            ...
            PageSize="20" NavigatePreviousText="上一页" NavigateNextText="下一页" MainTableStyle="text-align:center;"
            ...
            PageNumberBoxBorderColor="#0099FF" PageNumberHoverBorderColor="#0099FF" 
                    onpagechanged="UcfarPager1_PageChanged"  >
        </cc1:UcfarPager>
            </div>
        </div>
    </div>
