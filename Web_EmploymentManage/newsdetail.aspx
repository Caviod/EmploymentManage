...
<body>
    ...
    <div class="bg">
        ...
        <div class="newsdetail2-1">新闻详细</div>
        <div class="newsdetail2-2-title"><%=ns.NewsId!=0?ns.NewsTitle:""%></div>
        <div class="newsdetail2-2-about">作者：<%=ns.NewsId!=0?ns.Author:""%> 来源：<%=ns.NewsId!=0?ns.Source:""%> 发布时间：<%=ns.NewsId!=0?ns.ReleaseTime.ToString():""%></div>
