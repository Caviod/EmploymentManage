<%@ Page Language="C#" AutoEventWireup="true" CodeFile="myenterpriseinfodetail.aspx.cs" Inherits="myenterpriseinfodetail" %>
...
<%--                               <li><a href="userslistall.aspx"><span style="padding-left:60px;">查看所有求职者信息</span></a></li>
 ...
 <tr>
 <td style="text-align:left; padding-left:20px; padding-right:20px;"><span style=" float:left; font-weight:bold;">(<%=model.InfoType == 1 ? BLL.EnterpriseBLL.GetIdByEnterprise(model.EnterpriseId).UserName : BLL.UsersBLL.GetIdByUsers(model.UserId).UserName%>)<%=model.InfoType == 1 ? BLL.EnterpriseBLL.GetIdByEnterprise(model.EnterpriseId).EnterpriseName : BLL.UsersBLL.GetIdByUsers(model.UserId).RealName%></span><span style=" float:right;"><%=model.InfoTime%></span></td>
 </tr>
 <tr>
    <td style="text-align:left; padding-left:20px; padding-right:20px; line-height:20px; vertical-align:text-top;"><%=model.InfoContent%></td>
 </tr>
 </table>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; padding-left: 20px;">
                            <asp:Button ID="btnSend" runat="server" Text="发送" OnClientClick="return check()"
                                OnClick="btnSend_Click" />&nbsp;<input id="BtnBackProList" type="button" value="返回"  onclick='javascript:history.go(-1)'   />
                        </td>
                    </tr>
                </table>
