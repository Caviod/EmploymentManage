...
<body>
    ...
    <div class="bg">
                ...
                <table>
                    <tr >
                        <td style="height:100px; line-height:30px;">
                            关键字：<input id="txtKey" runat="server" title="标题" style="width: 100px;" type="text" /><br />
      ...
      <li><span style="float:left;"><a href="newsdetail.aspx?id=<%#Eval("NewsId")%>" target="_blank"><%#Eval("NewsTitle")%></a></span><span style="float:right;"><%#Convert.ToDateTime( Eval("ReleaseTime")).ToString("yyyy-MM-dd HH:mm")%></span></li>
